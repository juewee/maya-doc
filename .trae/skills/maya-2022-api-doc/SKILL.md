---
name: "maya-2022-api-doc"
description: "Provides Maya 2022 Python command documentation (maya.cmds). Includes 1503 commands with descriptions, Python examples, and category index. Invoke when user asks about Maya 2022 commands, Maya API, Maya Python scripting, maya.cmds usage, or needs code examples for Maya 2022 automation."
---

# Maya 2022 Python Command Documentation

This skill provides access to scraped Maya 2022 command documentation. All data is sourced from the official Autodesk Maya 2022 Chinese documentation.

## Data Files

```
.trae/skills/maya-2022-api-doc/data/
...
```json
{
  "meta": { "source": "...", "version": "Maya 2022", "total": 1503, ... },
  "commands": [
    {
      "name": "addAttr",
...
|--------|-------|
| Total commands | 1503 |
| Successfully scraped | 1190 |
| With description | 1184 |
| With Python examples | 1182 |
| HTTP 404 (no Python page) | 313 |

Some commands (313 out of 1503) have no Python-specific documentation page (HTTP 404). These commands may still be callable via `maya.cmds` but lack dedicated Python examples.
